...
export default function HomeOverlayUI({ selectedCategory, setSelectedCategory, userAvatar, userName }) {
  return (
        ...
        <div className="flex items-center gap-4 w-full ml-[15px] h-12">
          ...
          >
            {userAvatar ? (
              ...
              <CircleUserRound size={24} className="text-orange-500 flex-shrink-0" />
            )}
          </button>
          {/* Search box */}
          ...
          <div className="flex gap-2 ml-3">
            ...
            {categories.map((c) => (
              <button
                ...
                style={{
                  backgroundColor: selectedCategory === c.id ? c.activeBgColor : c.bgColor,
                  color: selectedCategory === c.id ? '#ffffff' : c.textColor
                }}
              >
