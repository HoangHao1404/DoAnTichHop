      ...
      <div className="relative w-full max-w-[540px] bg-white rounded-[24px] p-5 shadow-2xl flex flex-col max-h-[92vh] sm:max-h-[90vh] overflow-hidden mx-auto">
        ...
        <div className="flex flex-col flex-1 min-h-0 gap-2">
          ...
          <div className="flex flex-col items-start gap-1 shrink-0">
            <span className="inline-flex items-center rounded-full bg-[#FF7F1F] px-2 py-0.5 text-[9px] font-semibold text-white tracking-wide shadow-sm">
              Giao Thông
            </span>
          ...
          <div className="rounded-xl bg-gray-50/80 p-2.5 border border-gray-100 shrink-0">
            <p className="text-[12px] md:text-[13px] italic leading-relaxed text-gray-600 line-clamp-2">
              Có một ổ gà lớn gây nguy hiểm cho người tham gia giao thông, đặc biệt là xe máy. Kích thước khoảng 50cm x 30cm, sâu khoảng 15cm.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-x-5 gap-y-1.5 shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider mb-0.5">Mã báo cáo</span>
                <span className="text-[12px] md:text-[14px] font-bold text-blue-600">{report?.id || "---"}</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider mb-0.5">Vị trí</span>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider mb-0.5">Thời gian</span>
                <span className="text-[12px] md:text-[13px] font-medium text-gray-900">{report?.time || "---"}</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider mb-0.5">Trạng thái</span>
                <span className="text-[12px] md:text-[13px] font-bold text-[#FFB020]">Đang Xử Lý</span>
              </div>
            </div>
          </div>

          {/* Photo Section - This block will flexibly shrink vertically if short on space */}
          <div className="grid grid-cols-2 gap-3 mt-0 flex-1 min-h-[100px] max-h-[200px]">
            {/* Ảnh sự cố */}
            <div className="flex flex-col h-full bg-[#F7F8FA] rounded-2xl p-2.5 flex-1 min-h-0">
              ...
              {selectedImage ? (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <span className="text-white text-[11px] font-medium">Thay đổi ảnh</span>
                  </div>
                </div>
              ) : (
                <button 
                  onClick={() => fileInputRef.current.click()}
                  className="flex-1 w-full min-h-0 rounded-[12px] border-[1.5px] border-dashed border-gray-300 bg-transparent hover:bg-gray-100/50 transition-colors flex flex-col items-center justify-center gap-1.5 group"
                >
        ...
        <div className="flex items-center justify-end gap-2.5 mt-2.5 pt-3 border-t border-gray-100 shrink-0">
          <button 
            onClick={onClose}
            className="px-4 py-2 text-[13px] md:text-[14px] font-medium text-gray-600 hover:text-gray-900 transition-colors"
          >
            Hủy
          </button>
          <button className="flex items-center gap-1.5 rounded-[10px] bg-[#2b6cb0] hover:bg-blue-700 px-4 md:px-5 py-2 text-[13px] md:text-[14px] font-semibold text-white shadow-md transition-all active:scale-95">
            Cập nhật tiến độ
