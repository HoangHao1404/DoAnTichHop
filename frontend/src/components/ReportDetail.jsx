  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && close?.()}>
      <DialogContent
        ...
        className="z-[60] flex h-[min(94dvh,920px)] w-[calc(100vw-0.75rem)] max-w-none flex-col overflow-hidden rounded-[18px] border border-[#d8e6ff] bg-white p-0 shadow-[0_12px_40px_rgba(15,23,42,0.14)] outline-none focus:outline-none focus-visible:outline-none sm:w-[min(90vw,760px)] md:w-[min(86vw,780px)]"
      >
        <DialogHeader className="shrink-0 rounded-t-[18px] bg-white px-4 pt-4 sm:px-5 sm:pt-5 md:px-6 md:pt-6">
          <div className="flex items-start justify-between gap-3">
            <DialogTitle className="pr-2 text-base font-semibold leading-snug break-words text-zinc-900 sm:text-lg md:text-xl lg:text-2xl">
        ...
        <Separator className="mt-4 shrink-0 bg-[#dbe8ff]" />

        <ScrollArea className="min-h-0 flex-1 px-4 py-4 sm:px-5 md:px-6">
            ...
            <div className="grid gap-3 lg:grid-cols-2">
              <Card className="gap-0 rounded-[12px] border border-[#dce9ff] bg-[#f6faff] py-0 ring-0 shadow-sm">
                ...
                <CardContent className="px-3 pb-3 sm:px-4 sm:pb-4">
                  <div className="mx-auto h-[min(22vh,250px)] min-h-[140px] w-full overflow-hidden rounded-[10px] bg-white sm:min-h-[170px]">
                    {beforeImage ? (
                      <img
                        src={beforeImage}
                        alt="Anh su co"
              ...
              <Card className="gap-0 rounded-[12px] border border-[#dce9ff] bg-[#f6faff] py-0 ring-0 shadow-sm">
                ...
                <CardContent className="px-3 pb-3 sm:px-4 sm:pb-4">
                  <div className="mx-auto h-[min(22vh,250px)] min-h-[140px] w-full overflow-hidden rounded-[10px] bg-[#f2f2f2] sm:min-h-[170px]">
                    {showAfterImage ? (
                      <img
                        src={afterImage}
        ...
        <Separator className="shrink-0 bg-[#dbe8ff]" />

        <DialogFooter className="shrink-0 bg-white px-4 py-4 sm:px-5 md:px-6">
          <DialogClose asChild>
