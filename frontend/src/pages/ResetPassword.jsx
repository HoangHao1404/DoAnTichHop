    ...
    return (
      <div className="flex items-center justify-center min-h-screen px-4 bg-gray-50">
        <div className="text-center max-w-md mx-auto">
          <h2 className="text-xl xs:text-2xl sm:text-3xl font-semibold mb-2 xs:mb-3 sm:mb-4">Invalid Access</h2>
          <p className="text-xs xs:text-sm sm:text-base text-gray-600 mb-4 xs:mb-5 sm:mb-6">Please start from the Forgot Password page</p>
          <button
            onClick={() => navigate("/forgot-password")}
            className="bg-blue-600 text-white px-4 xs:px-6 py-2.5 xs:py-2.5 sm:py-2 rounded-lg text-xs xs:text-sm sm:text-base hover:bg-blue-700 font-medium"
          >
          ...
          <div className="w-[95vw] xs:w-[90vw] sm:w-[80vw] md:w-full max-w-[450px] mx-auto px-0 xs:px-2 sm:px-4">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4 xs:mb-5 sm:mb-6">
                <label className="text-xs xs:text-sm font-medium">OTP</label>
                <input
                  type="text"
              ...
              <div className="mb-4 xs:mb-5 sm:mb-6 relative">
                <label className="text-xs xs:text-sm font-medium">New Password</label>
                <input
                ...
                >
                  {showPassword ? <EyeOff size={18} className="xs:w-5 xs:h-5" /> : <Eye size={18} className="xs:w-5 xs:h-5" />}
                </button>
              </div>
              ...
              <div className="mb-4 xs:mb-5 sm:mb-6 relative">
                ...
                <button
                  ...
                  className="absolute right-3 xs:right-4 top-8 xs:top-9 text-gray-500 hover:text-gray-700 flex-shrink-0"
                >
                  {showConfirmPassword ? <EyeOff size={18} className="xs:w-5 xs:h-5" /> : <Eye size={18} className="xs:w-5 xs:h-5" />}
                </button>
              </div>
